...
from openpilot.selfdrive.ui.sunnypilot.layouts.sicuem_team_card import SicuemTeamCard
...
class HomeLayout(Widget):
  def __init__(self):
    ...
    self._team_card = SicuemTeamCard()
  ...
  def _render_left_column(self):
    self._team_card.render(self.left_column_rect)
