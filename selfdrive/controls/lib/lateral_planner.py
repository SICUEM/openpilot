...
class LateralPlanner:
  ...
  def update(self, sm):
    ...
    if self.model_use_lateral_planner:
      ...
      #AUTO
      if self.param_s.get_bool("ForceAutoLaneChange"):
      ...
      elif self.param_s.get_bool("ForceLaneChangeRight"):
        self.DH.desire = log.Desire.laneChangeRight
        self.DH.lane_change_state = log.LaneChangeState.preLaneChange
        self.DH.lane_change_direction = log.LaneChangeDirection.right
