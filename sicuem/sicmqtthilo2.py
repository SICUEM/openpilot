...
class SicMqttHilo2:
    ...
    def cargar_canales(self):
        ...
        try:
            ...
            print(f"Error: El archivo {self.jsonCanales} contiene un JSON inválido.")
            self.lista_suscripciones = []
            self.enabled_items = []
        except Exception as e:
            print(f"Error inesperado al cargar los canales: {e}")
            self.lista_suscripciones = []
            self.enabled_items = []

    # Más métodos con manejo de excepciones...
