...
class SicMqttHilo2:
  ...
  def initialize_variables(self):
    ...
    self.jsonCanales = os.path.join(_base_dir, "canales.json")  # Ruta al archivo JSON de configuración de canales
    self.jsonConfig = os.path.join(_base_dir, "config.json")  # Ruta al archivo JSON de configuración general
