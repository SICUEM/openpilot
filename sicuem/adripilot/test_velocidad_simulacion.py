...
# -*- coding: utf-8 -*-
"""
Script de prueba para simular el comportamiento de velocidad que necesitas:
- Si va a 40 km/h y llega comando -1, que baje a 39 km/h
- Si va a 40 km/h y llega comando +1, que suba a 41 km/h
"""
import json
import time
...
def main():
    ...
    try:
        ...
        print("   - 📊 Cambios en vCruise en los logs de telemetría")
