...
# -*- coding: utf-8 -*-
"""
Script de prueba actualizado basado en los logs reales
Usa el formato correcto que está enviando el servidor
"""
import time
...
def main():
    print("🚀 Prueba de Comandos del Servidor AdriPilot - ACTUALIZADO")
