...
Enfoque simplificado sin dependencias complejas
"""
import json
import time
...
def main():
    ...
    print("📋 Enfoque simplificado sin dependencias complejas")
    ...
    try:
        ...
        print("🎯 Esperado: Cambio en setSpeed y vCruise")
        ...
        print("   - 🚫 Sin errores de 'get_int_nonblocking' o 'controlsState'")
