...
# -*- coding: utf-8 -*-
"""
Script de prueba que simula exactamente lo que envía el servidor
...
def main():
    print("🚀 Prueba de Comandos del Servidor AdriPilot")
    print("📋 Simulando exactamente lo que envía el servidor")
