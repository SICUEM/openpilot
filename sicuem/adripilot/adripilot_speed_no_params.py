...
# -*- coding: utf-8 -*-
"""
Sistema de Control de Velocidad AdriPilot - Enfoque Sin Parámetros
No usa parámetros problemáticos, solo modifica directamente las variables
"""
import time
from openpilot.common.params import Params

class AdriPilotSpeedNoParams:
  """Controlador de velocidad sin parámetros problemáticos."""
  ...
  def process_speed_commands(self, car_control, car_state, v_cruise_helper):
    """Procesa comandos de velocidad sin usar parámetros problemáticos."""
    current_time = time.time()

    # Verificar comandos de velocidad usando get_bool directamente
    try:
      ...
      print(f"⚠️ Error leyendo parámetros: {e}")
      return
    ...
    if speed_increase or speed_decrease:
      ...
      try:
        ...
        print(f"⚠️ Error limpiando parámetros: {e}")
...
# Instancia global del controlador de velocidad sin parámetros
adripilot_speed_no_params = AdriPilotSpeedNoParams()
